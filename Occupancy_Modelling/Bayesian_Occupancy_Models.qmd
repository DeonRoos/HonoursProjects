...
> As a slight tangent, you can think of frequentist statistics as using insanely vague guesses for priors. For instance, the above model would be (kind of) similar to: 
>
> $$ y_i \sim Bernoulli(p_i) $$
>
> $$ logit(p_i) = \beta_0 $$
